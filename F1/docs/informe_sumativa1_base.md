...
## Portada
- Curso: Programación para la Ciencia (202681.2535)
- Proyecto: Proyecto ABP - Ciencia de Datos Reproducible
- Integrantes: Pablo Villalobos / Rodrigo Chinchón / Sergio Fernández
...
Stack tecnológico utilizado: Python, Jupyter, NumPy, Pandas, Matplotlib, Scikit-learn, Git/GitHub.
...
| Sistema operativo | Shell      | Comando                          |
| ----------------- | ---------- | -------------------------------- |
| Windows           | PowerShell | `.\.venv\Scripts\Activate.ps1`   |
| Linux / macOS     | Bash       | `source .venv/bin/activate`      |

Las dependencias utilizadas en esta fase se encuentran registradas en requirements.txt, permitiendo reproducir el entorno mediante la instalación automatizada de paquetes con `pip install -r requirements.txt`.
...
La estructura colaborativa considera el uso de ramas, integración mediante Pull Requests y documentación de cambios significativos, asegurando trazabilidad y gobernanza técnica durante todo el ciclo de vida del proyecto. La rama `main` se encuentra protegida mediante reglas que exigen la integración de cambios exclusivamente a través de Pull Requests.

### Evidencia de contribución por integrante
A continuación se registran los commits y Pull Requests realizados por cada integrante del equipo. La evidencia se obtiene del historial del repositorio mediante `git shortlog -sne` y de la pestaña de Pull Requests de GitHub.

| Integrante                  | N.º de commits | Pull Requests | Evidencia |
| --------------------------- | -------------- | ------------- | --------- |
| Rodrigo Chinchón Ayala      | <completar>    | <completar>   | <capturas / enlace> |
| Pablo Villalobos González   | <completar>    | <completar>   | <capturas / enlace> |
| Sergio Fernández Almonacid  | <completar>    | <completar>   | <capturas / enlace> |

> Nota: completar con el conteo real de commits y los enlaces a los Pull Requests de cada integrante antes de la entrega. Este punto es evaluado por la rúbrica (autoría individual).
...
Durante la Fase 1 se definieron las decisiones técnicas fundamentales para garantizar reproducibilidad y colaboración. Entre las principales decisiones adoptadas se encuentran:
...
El repositorio fue estructurado siguiendo criterios de reproducibilidad y organización documental. Incluye:
